...
% See also: pop_reref
 ...
 REF1 = []; REF2 = [];
 if ~isempty(strmatch('Ref1',{chanlocs.labels})); REF1 = strmatch('Ref1',{chanlocs.labels}); end
 if ~isempty(strmatch('Ref2',{chanlocs.labels})); REF2 = strmatch('Ref2',{chanlocs.labels}); end
 REF = [REF1  REF2];
